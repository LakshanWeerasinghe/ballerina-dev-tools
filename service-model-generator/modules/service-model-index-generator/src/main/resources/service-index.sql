...
DROP TABLE IF EXISTS AttachToService;
...
-- Create AttachToService table
CREATE TABLE AttachToService (
    attachment_id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL,
    kind TEXT CHECK(kind IN ('SERVICE', 'LISTENER')),
    package_id INTEGER,
...
CREATE TABLE Function (
    ...
    FOREIGN KEY (attachment_id) REFERENCES AttachToService(attachment_id) ON DELETE CASCADE
);
